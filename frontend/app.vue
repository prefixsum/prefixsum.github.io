<template>
  <div
    class="relative flex min-h-screen flex-col justify-center space-y-5 overflow-hidden bg-slate-900"
  >
    <div
    ...
    >
      <h1 class="pb-2 text-center text-4xl font-bold text-transparent">
        prefixsum
      </h1>
    </div>
